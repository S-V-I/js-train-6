//Завдання 1.Cтворіть об'єкт person за допомогою конструктора
// з полями name: "John",age: 25
let person = {};
...
// та вкладений об'єкт address з полями  street: "123 Main St",
// city: "New York", country: "USA",
let personLarge = {
  //використовуємо деструктуризацію на об'єкті person
...
//Завдання 3: Створіть функцію, що повертає новий об'єкт з тими ж
// властивостями, що й переданий у якості аргумента об'єкт.
...
function copyObject(obj) {
  // Використовуємо синтаксис деструктурізації {...person} для створення
  // нового об'єкта з тими ж властивостями
...
////Завдання 4. Перевірте наявність властивості в об'єкті
...
// Завдання 5: Створіть функцію, що отримує об'єкт і виводить на консоль
// всі його ключі та значення.
let country = {
  name: "United States",
...
let user = {
  name: "John",
  age: 25,
  // Створюємо метод introduce, який за допомогою ключового слова this
  // має повернути такий рядок
...
function destructureObject(obj) {
  // Використовуємо деструктуризацію для створення нових змінних
  // з властивостей об'єкту і отримуємо з нього змінні brand та model
...
// Завдання 11: Використовуйте вкладені об'єкти для зберігання
// більш складної інформації.
...
// Завдання 12: Показати, що об'єкти будуть дорівнювати один одному
// лише тоді, коли одному об'єкту присвоїти значення іншого.
// Створіть два об'єкти planet1 та planet2 з полями
...
// Завдання 13: Використовуйте деструктуризацію зі значенням
// за замовчуванням у аргументах функції для об'єкта.
let car = {
  brand: "BMW",
  year: 2022,
};
// Створюємо функцію, яка приймає об'єкт як аргумент і використовує
// деструктуризацію зі значенням за замовчуванням
// brand за замовчуванням призначимо Unknown, year за замовчуванням
// призначимо 0, country за замовчуванням призначемо Unknown
...
// Завдання 14: Додайте нову властивість до вбудованого об'єкту Array
// через літерал.
// Створюємо функцію, яка буде додавати нову властивість до масиву
function addProperty(array) {
  // Додаємо нову властивість customProperty до прототипу Array
  // зі значенням myProperty
...
// Створимо масив newArr з новою властивістю за допомогої нашої функції
// в яку передамо [1, 2, 3, 4, 5]
